aws emr create-cluster \
  ...
  --instance-fleets InstanceFleetType=MASTER,TargetOnDemandCapacity=1,InstanceTypeConfigs=['{InstanceType=r4.2xlarge}'] InstanceFleetType=CORE,TargetSpotCapacity=8,InstanceTypeConfigs=['{InstanceType=r4.2xlarge,BidPrice=0.5,WeightedCapacity=1}'],LaunchSpecifications={SpotSpecification='{TimeoutDurationMinutes=5,TimeoutAction=SWITCH_TO_ON_DEMAND}'}
